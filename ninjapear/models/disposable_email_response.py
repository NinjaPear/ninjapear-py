...
class DisposableEmailResponse(BaseModel):
    ...
    is_disposable_email: Optional[StrictBool] = Field(default=None, description="Whether the email domain is a known disposable/temporary email provider")
    is_free_email: Optional[StrictBool] = Field(default=None, description="Whether the email domain is a free email provider")
    __properties: ClassVar[List[str]] = ["email", "is_disposable_email", "is_free_email"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "email": obj.get("email"),
            "is_disposable_email": obj.get("is_disposable_email"),
            "is_free_email": obj.get("is_free_email")
        })
        return _obj
