...
from ninjapear.configuration import Configuration
from ninjapear.api_response import ApiResponse, T as ApiResponseT
import ninjapear.models
from ninjapear import rest
from ninjapear.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ninjapear.models, klass)
