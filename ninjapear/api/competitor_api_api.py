...
class CompetitorAPIApi:
    ...
    def get_competitor_listing(
        ...
        _param = self._get_competitor_listing_serialize(
            website=website,
    ...
    @validate_call
    def get_competitor_listing_with_http_info(
        self,
        website: Annotated[StrictStr, Field(description="The website URL or company name of the target company. A website URL (e.g. `https://www.stripe.com`) is strongly recommended for precision.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CompetitorListingResponse]:
        """Competitor Listing
    ...
    @validate_call
    def get_competitor_listing_without_preload_content(
        self,
        website: Annotated[StrictStr, Field(description="The website URL or company name of the target company. A website URL (e.g. `https://www.stripe.com`) is strongly recommended for precision.")],
        _request_timeout: Union[
            None,
    ...
    def _get_competitor_listing_serialize(
        self,
        website,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/competitor/listing',
