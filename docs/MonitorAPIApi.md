# ninjapear.MonitorAPIApi

All URIs are relative to *https://nubela.co*

Method | HTTP request | Description
------------- | ------------- | -------------
[**add_target**](MonitorAPIApi.md#add_target) | **POST** /api/v1/monitor/feeds/{feed_id}/targets | Add Target
[**create_feed**](MonitorAPIApi.md#create_feed) | **POST** /api/v1/monitor/feeds | Create Feed
[**delete_feed**](MonitorAPIApi.md#delete_feed) | **DELETE** /api/v1/monitor/feeds/{feed_id} | Delete Feed
[**delete_target**](MonitorAPIApi.md#delete_target) | **DELETE** /api/v1/monitor/feeds/{feed_id}/targets/{target_id} | Delete Target
[**get_feed**](MonitorAPIApi.md#get_feed) | **GET** /api/v1/monitor/feeds/{feed_id} | Get Feed
[**get_rss_feed**](MonitorAPIApi.md#get_rss_feed) | **GET** /api/v1/monitor/feeds/{feed_id}/rss.xml | Get RSS Feed
[**list_feeds**](MonitorAPIApi.md#list_feeds) | **GET** /api/v1/monitor/feeds | List Feeds
[**update_feed**](MonitorAPIApi.md#update_feed) | **PATCH** /api/v1/monitor/feeds/{feed_id} | Update Feed
[**update_target**](MonitorAPIApi.md#update_target) | **PATCH** /api/v1/monitor/feeds/{feed_id}/targets/{target_id} | Update Target
...
with ninjapear.ApiClient(configuration) as api_client:
    ...
    api_instance = ninjapear.MonitorAPIApi(api_client)
    ...
    try:
        ...
        print("The response of MonitorAPIApi->add_target:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonitorAPIApi->add_target: %s\n" % e)
```
...
with ninjapear.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MonitorAPIApi->create_feed:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonitorAPIApi->create_feed: %s\n" % e)
```
...
with ninjapear.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MonitorAPIApi->delete_feed:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonitorAPIApi->delete_feed: %s\n" % e)
```
...
with ninjapear.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MonitorAPIApi->delete_target:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonitorAPIApi->delete_target: %s\n" % e)
```
...
with ninjapear.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MonitorAPIApi->get_feed:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonitorAPIApi->get_feed: %s\n" % e)
```
...
with ninjapear.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MonitorAPIApi->get_rss_feed:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonitorAPIApi->get_rss_feed: %s\n" % e)
```
...
with ninjapear.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MonitorAPIApi->list_feeds:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonitorAPIApi->list_feeds: %s\n" % e)
```
...
with ninjapear.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MonitorAPIApi->update_feed:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonitorAPIApi->update_feed: %s\n" % e)
```
...
with ninjapear.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MonitorAPIApi->update_target:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonitorAPIApi->update_target: %s\n" % e)
```
