...
------------ | ------------- | ------------- | -------------
**name** | **str** | Feed display name. Auto-generated if not provided. | [optional] 
**targets** | [**List[CreateFeedRequestTargetsInner]**](CreateFeedRequestTargetsInner.md) | Initial targets to monitor | 
**is_public** | **bool** | Whether the RSS feed should be publicly accessible | [optional] [default to False]
