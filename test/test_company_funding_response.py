...
class TestCompanyFundingResponse(unittest.TestCase):
    """CompanyFundingResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyFundingResponse:
        """Test CompanyFundingResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyFundingResponse`
        """
        model = CompanyFundingResponse()
        if include_optional:
            return CompanyFundingResponse(
                total_funds_raised_usd = 2200000000,
                funding_rounds = [
                    ninjapear.models.funding_round.FundingRound(
                        round_type = 'SERIES_A', 
                        date = '2021-03-14', 
                        amount_usd = 600000000, 
                        investors = [
                            ninjapear.models.investor.Investor(
    ...
    def testCompanyFundingResponse(self):
        """Test CompanyFundingResponse"""
