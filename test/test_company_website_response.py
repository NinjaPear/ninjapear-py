...
class TestCompanyWebsiteResponse(unittest.TestCase):
    """CompanyWebsiteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyWebsiteResponse:
        """Test CompanyWebsiteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyWebsiteResponse`
        """
        model = CompanyWebsiteResponse()
        if include_optional:
            return CompanyWebsiteResponse(
    ...
    def testCompanyWebsiteResponse(self):
        """Test CompanyWebsiteResponse"""
