...
class TestDisposableEmailResponse(unittest.TestCase):
    """DisposableEmailResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DisposableEmailResponse:
        """Test DisposableEmailResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DisposableEmailResponse`
        """
        model = DisposableEmailResponse()
        if include_optional:
    ...
    def testDisposableEmailResponse(self):
        """Test DisposableEmailResponse"""
