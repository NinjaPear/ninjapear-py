...
class TestFundingRound(unittest.TestCase):
    """FundingRound unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FundingRound:
        """Test FundingRound
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FundingRound`
        """
        model = FundingRound()
        if include_optional:
            return FundingRound(
