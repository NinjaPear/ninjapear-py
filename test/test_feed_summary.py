...
class TestFeedSummary(unittest.TestCase):
    """FeedSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeedSummary:
        """Test FeedSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeedSummary`
        """
        model = FeedSummary()
        if include_optional:
            return FeedSummary(
