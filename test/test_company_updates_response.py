...
class TestCompanyUpdatesResponse(unittest.TestCase):
    """CompanyUpdatesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyUpdatesResponse:
        """Test CompanyUpdatesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyUpdatesResponse`
        """
        model = CompanyUpdatesResponse()
        if include_optional:
            return CompanyUpdatesResponse(
                blogs = [
                    ''
                    ],
                x_profile = 'https://x.com/stripe',
                updates = [
                    ninjapear.models.company_update.CompanyUpdate(
                        url = 'https://stripe.com/blog/payment-links', 
    ...
    def testCompanyUpdatesResponse(self):
        """Test CompanyUpdatesResponse"""
