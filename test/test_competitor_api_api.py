...
class TestCompetitorAPIApi(unittest.TestCase):
    """CompetitorAPIApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CompetitorAPIApi()

    def tearDown(self) -> None:
        pass

    def test_get_competitor_listing(self) -> None:
        """Test case for get_competitor_listing
