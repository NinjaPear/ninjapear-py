...
class TestCustomerListingResponse(unittest.TestCase):
    """CustomerListingResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomerListingResponse:
        """Test CustomerListingResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomerListingResponse`
        """
        model = CustomerListingResponse()
        if include_optional:
            return CustomerListingResponse(
                customers = [
                    ninjapear.models.customer_company.CustomerCompany(
                        name = 'Apple', 
    ...
    def testCustomerListingResponse(self):
        """Test CustomerListingResponse"""
