...
class TestCompetitorListingResponse(unittest.TestCase):
    """CompetitorListingResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompetitorListingResponse:
        """Test CompetitorListingResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompetitorListingResponse`
        """
        model = CompetitorListingResponse()
        if include_optional:
            return CompetitorListingResponse(
                competitors = [
                    ninjapear.models.competitor_company.CompetitorCompany(
    ...
    def testCompetitorListingResponse(self):
        """Test CompetitorListingResponse"""
