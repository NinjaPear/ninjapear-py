...
class TestAddTargetRequest(unittest.TestCase):
    """AddTargetRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddTargetRequest:
        """Test AddTargetRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddTargetRequest`
        """
        model = AddTargetRequest()
        if include_optional:
