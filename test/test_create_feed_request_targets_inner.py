...
class TestCreateFeedRequestTargetsInner(unittest.TestCase):
    """CreateFeedRequestTargetsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateFeedRequestTargetsInner:
        """Test CreateFeedRequestTargetsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateFeedRequestTargetsInner`
        """
        model = CreateFeedRequestTargetsInner()
        if include_optional:
            return CreateFeedRequestTargetsInner(
    ...
    def testCreateFeedRequestTargetsInner(self):
        """Test CreateFeedRequestTargetsInner"""
